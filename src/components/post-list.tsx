...
export default function PostList({ posts, heading, orientation = "vertical" }: PostListProps) {
    ...
    return (
        <div className="max-w-[1160px] mx-auto px-6 xl:pt-4 xl:pb-[96px]">
                        ...
                        <div className="py-[17.5px]">
                            ...
                            </div>
                            {
                                isVertical ?
                                    ...
                                    <TypographyH2 className="mt-1 xl:mb-[8px] mb-[8px]  font-sans  xl:text-[26px] text-[18px]">{post.title}</TypographyH2>
                            }
