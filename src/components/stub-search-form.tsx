...
export default function StubSearchForm({ className }: StubSearchFormProps) {
    ...
    return (
        <Link href="/search" className={cn("flex relative", className)}>
            <Input disabled className="border-0 border-b-[1px] border-b-dark rounded-none placeholder:text-slate-400 placeholder:text-[14px] placeholder:font-sans py-[8px] pl-[32px] focus:border-none" placeholder="Buscar..." />
