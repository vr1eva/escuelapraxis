...
import { TypographyBodyLight, TypographyBodyRegular, TypographyH1, TypographyH2, TypographyLink, TypographySubtitle, TypographyTitle, typographyBodyRegularClassNames } from "@/components/typography"
...
export default async function Page() {
    return (
        <main className="min-h-screen mb-[96px]">
            <Banner image={lecturaCritica} />
            <Index />
            <Separator className="xl:max-w-[1160px] max-w-[90%] mx-auto mt-[56px] xl:mt-[101px] mb-[8px]" />
            <Novedades />
        </main>
    )
}
...
async function Novedades() {
    ...
    return (
        <section className="max-w-[1160px] mx-auto">
            <PostList heading="Novedades" posts={latestPosts} />
        </section>
    )
}
...
async function Index() {
    ...
    return (
        <section className="flex gap-[136px] xl:gap-[64px] xl:items-start max-w-[1160px] mx-auto flex-col xl:flex-row">
            <div className="p-[32px_24px] xl:p-[37px_0_0]">
            ...
            <div className="-mt-[100px] flex flex-col p-[24px_24px_59px] bg-dark text-white xl:max-w-[401px] w-full relative z-10 ">
                <TypographyTitle><PostType type={specialPost._type} /></TypographyTitle>
                ...
                <TypographyBodyLight className="mt-[8px]"><Link href="/reseña/1">  <TypographyLink className="inline underline">Seguir leyendo</TypographyLink></Link></TypographyBodyLight>
            </div>
        </section>
    )
}
...
function IndexLink({ link }: IndexLinkProps) {
    return (
        <Link href={link.href} className="flex flex-col gap-4 items-center  shrink-0">
            <div className="h-[160px] w-[160px] xl:h-[204px] xl:w-[204px]">
